...
import static com.example.bloodbank.MainActivity.database;
...
public class DonorForm extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] citis = new String[]{"Nairobi","Mombasa", "Kisumu", "Garisa","Kitale", "Kiambu", "Narok", "Kisii","Embu","Meru", "Nyeri"};
